...
import { BarcodeScannerWorkerManager, generateBarcodeScannerDefaultConfig, generateDefaultBarcodeScannerParams, BarcodeScannerConfig, BarcodeScannerOperationParams, BarcodeScannerType, BarcodeInfo } from '@dannadori/barcode-scanner-worker-js'
...
const App = () => {
    ...
    }, [processSizeKey, useSIMD, processScaleKey, scanModeKey])
            ...
            <div style={{ position:"relative", display: "flex", flexDirection:"column" }}>
                ...
                <div style={{ position:"relative" }}>
                    {inputMedia.mediaType === "IMAGE" ?
                        ...
                        <img className={classes.inputView} style={{width:"100%", position:"absolute"}} id="input_img" alt=""></img>
                        :
