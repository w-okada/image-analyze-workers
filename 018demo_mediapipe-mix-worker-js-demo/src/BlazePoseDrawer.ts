import { MediapipeMixConfig, MediapipeMixOperationParams, PartsLookupIndices, PosePredictionEx } from "@dannadori/mediapipe-mix-worker-js";
...
export class BlazePoseDrawer {
    ...
    draw = (snap: HTMLCanvasElement, _config: MediapipeMixConfig, _params: MediapipeMixOperationParams, pred: PosePredictionEx) => {
