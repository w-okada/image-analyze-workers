import { FacePredictionEx, MediapipeMixConfig, MediapipeMixOperationParams, TRIANGULATION, NUM_KEYPOINTS } from "@dannadori/mediapipe-mix-worker-js";
...
export class FacemeshDrawer {
    ...
    draw = (snap: HTMLCanvasElement, _config: MediapipeMixConfig, _params: MediapipeMixOperationParams, prediction: FacePredictionEx) => {
        ...
        const keypoints = prediction.singlePersonKeypointsMovingAverage!
        const scaleW = 1
        const scaleH = 1
