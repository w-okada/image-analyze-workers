...
import { generateDefaultSuperResolutionParams, generateSuperResolutionDefaultConfig, SuperResolutionConfig, SuperResolutionOperationParams } from "@dannadori/super-resolution-worker-js";
...
type AppStateValue = {
    ...
    setConfig: (config: SuperResolutionConfig) => void;
    params: SuperResolutionOperationParams;
    setParams: (params: SuperResolutionOperationParams) => void;
};
...
const initialConfig = generateSuperResolutionDefaultConfig();
const initialParams = generateDefaultSuperResolutionParams();
