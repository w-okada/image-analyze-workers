...
import { generateDefaultHandPoseParams, generateHandPoseDefaultConfig, HandPoseWorkerManager } from '@dannadori/handpose-worker-js';
...
const App = () => {
    ...
    }, [flip, processHeight, processWidth])
