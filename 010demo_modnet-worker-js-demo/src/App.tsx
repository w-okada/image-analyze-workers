...
import { generateDefaultMODNetParams, generateMODNetDefaultConfig, MODNetWorkerManager, MODNetConfig, MODNetOperationParams, MODEL_INPUT_SIZES } from "@dannadori/modnet-worker-js";

let GlobalLoopID = 0;

const models: { [name: string]: string } = {
    webcam_192_16: `/webcam_192_16/model.json`,
    webcam_256_16: `/webcam_192_16/model.json`,
    webcam_512_16: `/webcam_192_16/model.json`,
};
