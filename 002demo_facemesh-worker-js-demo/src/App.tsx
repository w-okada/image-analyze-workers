import './App.css';
import {FacemeshWorkerManager, FacemeshConfig, generateFacemeshDefaultConfig, generateDefaultFacemeshParams,
  FacemeshFunctionType, FacemeshOperatipnParams, AnnotatedPrediction, Coords3D } from '@dannadori/facemesh-worker-js'
...
class App extends DemoBase {
  manager:FacemeshWorkerManager = new FacemeshWorkerManager()
  config:FacemeshConfig = (()=>{
    const conf = generateFacemeshDefaultConfig()
    return conf
  })()
  ...
  getCustomMenu = () => {
    const menu: ControllerUIProp[] = [
      ...
      },
      {
        ...
        values: ["detectMesh"],        
        callback: (val: string | number | MediaStream) => {
          this.params.type = FacemeshFunctionType.DetectMesh
        },
      },
      {
        title: "ProcessWidth",
  ...
  handleResult = (prediction: any) => {
    prediction = prediction as AnnotatedPrediction[]
    this.drawResult(prediction, this.params)
  }
