...
export const DropDown: FC<DropDownProps> = ({ title, current, options, onchange }: DropDownProps) => {
...
export const VideoInputSelect: FC<VideoInputSelectProps> = ({ title, current, options, onchange }: VideoInputSelectProps) => {
