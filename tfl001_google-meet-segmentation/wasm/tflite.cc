...
namespace{
    ...
    ///// オプション
    // int kernelSize = 1;  /// !!!!!!!!!!!!!!! deprecated!!
    // int useSoftmax = 0;  /// !!!!!!!!!!!!!!! deprecated!!
    // int usePadding = 0;  /// !!!!!!!!!!!!!!! deprecated!!
...
extern "C"
{
    ...
    //     printf("[WASM] JBF start\n");
    //     cv::Mat res, joint = grayOutputMat.clone();
    //     cv::ximgproc::jointBilateralFilter(joint, grayOutputMat, res, 0, 10, 10);
    //     printf("[WASM]  JBF start\n");
    //     return 0;
    // }
