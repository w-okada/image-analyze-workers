#ifndef __MEDIAPIPE_HAND_ANCHOR_HPP__
#define __MEDIAPIPE_HAND_ANCHOR_HPP__
...
int generate_ssd_anchors(std::vector<Anchor> *anchors, int type); // type: PALM_256, PALM_192

#endif //__MEDIAPIPE_HAND_ANCHOR_HPP__